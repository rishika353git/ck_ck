                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="col-sm-6 section-1" style="float: left !important;">
                                        <h2 class="card-title">Forums Categories</h2>
                                    </div>
                                    <div class="col-sm-6 section-2"
                                        ...
                                        <button type="button" class="btn bg-primary"><a
                                                href="{{ route('forums.create') }}">Add Forums</a></button>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td class="project-actions">
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('forums.edit', ['id' => $forum->id]) }}">
                                                    <i class="fas fa-pencil-alt"></i>
                                                    Edit
                                                </a>
                                                @if ($forum->status == 0)
                                                <a class="btn btn-success btn-sm"
                                                    href="{{ route('forums.enable', ['id' => $forum->id]) }}"
                                            ...
                                            {{-- <i class="fa-solid fa-eye-slash"></i> --}}
                                                <a class="btn btn-danger btn-sm"
                                                    href="{{ route('forums.disable', ['id' => $forum->id]) }}"
