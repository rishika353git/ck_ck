                                ...
                                <tbody>
                                    @foreach ($users as $user)
                                        <tr class="text-center">
                                            ...
                                            <td>{{ $user->email }}</td>
                                            <td>{{ $user->mobile }}</td>
                                            <td><img class="img-fluid clickable-image-front" src="{{ asset('storage/' . $user->card_front) }}" alt="Photo" height="70px" width="140px"></td>
                                            <td>
                                                <img class="img-fluid clickable-image-back" src="{{ asset('storage/' . $user->card_back) }}" alt="Photo" height="70px" width="140px">
                                            </td>
